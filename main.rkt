...
(require (rename-in "private/ffi.rkt" (hid-enumerate hid-enumerate-ffi))
         racket/contract
         racket/list
...
(define (hid-send-feature-report-full device bstr)
  (hid-send-feature-report device bstr (bytes-length bstr)))
